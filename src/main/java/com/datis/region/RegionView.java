...
public class RegionView {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "region1");
        ...
        KTable<String, Long> counts = source.map(new KeyValueMapper<Long, String, KeyValue<String, String>>() {
            @Override
            public KeyValue<String, String> apply(Long key, String value) {
                System.out.println("INPUT FROM HERE ***********************:");
                System.out.println("INPUT FROM HERE :" + key + "      Value:" + value);
